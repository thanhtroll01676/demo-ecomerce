                ...
                @foreach($cart as $id => $product)
                    <div class="row no-margin cart-item">
                        ...
                        <div class="col-xs-12 col-sm-5 ">
                            <div class="title">
                                <a href="{{ route('frontend.home.show', ['id' => $id, 'slug' => str_slug($product['name'])]) }}">{{ $product['name'] }}</a>
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-3 no-margin">
                            <div class="quantity">
                                <div class="le-quantity">
                                    ...
                                    <input name="cart[{{ $id }}]" readonly="readonly" type="text" value="{{ $product['quantity'] }}"/>
                        ...
                        <div class="col-xs-12 col-sm-2 no-margin">
                            ...
                            <a class="close-btn" href="{{ route('frontend.cart.deleteCart', ['id' => $id]) }}"></a>
                        </div>
                    </div><!-- /.cart-item -->
                @endforeach
                ...
                <div class="body">
                    ...
                    <div class="buttons-holder">
                        <a class="le-button big"
                           href="{{ route('frontend.checkout.index') }}">Thanh toán</a>
                        <a class="simple-link block"
                           href="{{ route('frontend.home.index') }}">Tiếp tục
                            shopping</a>
                    </div>
                </div>
            </div><!-- /.widget -->
