        ...
        <div class="container">
            <div class="col-xs-12 no-margin">
                ...
                <div class="billing-address">
                    <h2 class="border h1">Địa chỉ giao hàng</h2>
                    <form method="post" action="{{ route('frontend.checkout.placeOrder') }}" id="billing-info">
                        ...
                        <div class="row field-row">
                            <div class="col-xs-12 col-sm-8 {{ $errors->has('address') ? 'has-error' : '' }}">
                                <label>Địa chỉ*</label>
                                <input class="le-input" placeholder="street address"
                    ...
                    <form>
                        ...
                        <div class="row no-margin order-item">
                            ...
                            <div class="col-xs-12 col-sm-2 no-margin">
                                <div class="price">{{ number_format($product->subtotal, 0, ',', '.') }}</div>
                            </div>
                        </div><!-- /.order-item -->
                        @endforeach
                    </form>
