 ...
 * Generated for Laravel 5.4.36 on 2018-05-27 11:19:24.
 *
...
namespace App\MyLibrary\Facades { 
    ...
    class Tool {
         ...
         * @static 
         */ 
        public static function getThumbnail($subfolder_filename, $suffix = '_thumb')
        {
            return \App\MyLibrary\ToolFactory::getThumbnail($subfolder_filename, $suffix);
        }
         ...
         * @static 
         */ 
        public static function getVND($number)
        {
            return \App\MyLibrary\ToolFactory::getVND($number);
        }
...
namespace  { 
    ...
    class Tool extends \App\MyLibrary\Facades\Tool {}
